...
class ntty_config_settings(models.Model):
	...
	ntty_sold = fields.Boolean(string='Can be Sold',default=True)
	ntty_purchased = fields.Boolean(string='Can be Purchased',default=True)
	ntty_mto = fields.Boolean(string='Make To Order',default=True)
